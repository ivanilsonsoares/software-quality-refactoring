...
public class EditarPaciente extends javax.swing.JFrame {
    ...
    private void cadastrar() {
        ...
        String RG = Formatacao.removeRGmask(tRG.getText()); // NOPMD by ivani on 09/08/2021 21:28
        ...
        if(!ValidationAux.CPFisValid(CPF)) {
...
//            return ; 
//        }
//        if(!ValidationAux.dateIsValid(tDataNasc.getText())) {
...
//            return ;
//        }
        String CEP = Formatacao.removeCEPmask(tCEP.getText()); // NOPMD by ivani on 09/08/2021 21:29
        Endereco e = null;
