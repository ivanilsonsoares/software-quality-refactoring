...
public class EditarAvaliacao extends javax.swing.JFrame implements TelaAntecedente {
    private EditarAvaliacaoProduct2 editarAvaliacaoProduct2 = new EditarAvaliacaoProduct2();
	private EditarAvaliacaoProduct editarAvaliacaoProduct = new EditarAvaliacaoProduct();
    ...
    public EditarAvaliacao(Main tela, Avaliacao a) {
        ...
        editarAvaliacaoProduct.getBSalvarAvaliacao().setModel(new FixedButtonModel());
        editarAvaliacaoProduct.getBSalvarAvaliacao().setBorder(BorderFactory.createEtchedBorder(0));
        ...
        editarAvaliacaoProduct2.getBBuscarPaciente().setModel(new FixedButtonModel());
        editarAvaliacaoProduct2.getBBuscarPaciente().setBorder(BorderFactory.createEtchedBorder(0));
    ...
    private void initComponents() {
        ...
        editarAvaliacaoProduct2.setBBuscarPaciente(new javax.swing.JButton());
        ...
        editarAvaliacaoProduct.setBSalvarAvaliacao(new javax.swing.JButton());
        ...
        editarAvaliacaoProduct2.getBBuscarPaciente().setBackground(new java.awt.Color(0, 102, 52));
        editarAvaliacaoProduct2.getBBuscarPaciente().setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        editarAvaliacaoProduct2.getBBuscarPaciente().setForeground(new java.awt.Color(255, 255, 255));
        editarAvaliacaoProduct2.getBBuscarPaciente().setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons/search.png"))); // NOI18N
        editarAvaliacaoProduct2.getBBuscarPaciente().setText("Buscar Paciente");
        editarAvaliacaoProduct2.getBBuscarPaciente().setBorder(null);
        editarAvaliacaoProduct2.getBBuscarPaciente().setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        editarAvaliacaoProduct2.getBBuscarPaciente().setDoubleBuffered(true);
        editarAvaliacaoProduct2.getBBuscarPaciente().addFocusListener(new java.awt.event.FocusAdapter() {
        ...
        editarAvaliacaoProduct2.getBBuscarPaciente().addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                bBuscarPacienteMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                editarAvaliacaoProduct2.bBuscarPacienteMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                editarAvaliacaoProduct2.bBuscarPacienteMouseExited(evt);
            }
        });
        editarAvaliacaoProduct2.getBBuscarPaciente().addActionListener(new java.awt.event.ActionListener() {
        ...
        editarAvaliacaoProduct.getBSalvarAvaliacao().setBackground(new java.awt.Color(0, 102, 52));
        editarAvaliacaoProduct.getBSalvarAvaliacao().setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        editarAvaliacaoProduct.getBSalvarAvaliacao().setForeground(new java.awt.Color(255, 255, 255));
        editarAvaliacaoProduct.getBSalvarAvaliacao().setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/icons/checked.png"))); // NOI18N
        editarAvaliacaoProduct.getBSalvarAvaliacao().setText("Salvar");
        editarAvaliacaoProduct.getBSalvarAvaliacao().setBorder(null);
        editarAvaliacaoProduct.getBSalvarAvaliacao().setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        editarAvaliacaoProduct.getBSalvarAvaliacao().setDoubleBuffered(true);
        editarAvaliacaoProduct.getBSalvarAvaliacao().addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                editarAvaliacaoProduct.bSalvarAvaliacaoFocusGained(evt);
            }
            public void focusLost(java.awt.event.FocusEvent evt) {
                editarAvaliacaoProduct.bSalvarAvaliacaoFocusLost(evt);
            }
        });
        editarAvaliacaoProduct.getBSalvarAvaliacao().addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                bSalvarAvaliacaoMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
                editarAvaliacaoProduct.bSalvarAvaliacaoMouseEntered(evt);
            }
            public void mouseExited(java.awt.event.MouseEvent evt) {
                editarAvaliacaoProduct.bSalvarAvaliacaoMouseExited(evt);
            }
        });
                    ...
                    .addGroup(inputLayout.createSequentialGroup()
                        ...
                        .addGroup(inputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, inputLayout.createSequentialGroup()
                                ...
                                .addComponent(editarAvaliacaoProduct.getBSalvarAvaliacao(), javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
                            ...
                            .addGroup(inputLayout.createSequentialGroup()
                                .addComponent(editarAvaliacaoProduct2.getBBuscarPaciente(), javax.swing.GroupLayout.PREFERRED_SIZE, 170, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        inputLayout.setVerticalGroup(
            ...
            .addGroup(inputLayout.createSequentialGroup()
                .addGroup(inputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(editarAvaliacaoProduct2.getBBuscarPaciente(), javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
                ...
                .addGroup(inputLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(editarAvaliacaoProduct.getBSalvarAvaliacao(), javax.swing.GroupLayout.PREFERRED_SIZE, 34, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void bSalvarAvaliacaoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bSalvarAvaliacaoMouseClicked
        if (!Validacao.timeIsValid(tData.getText())) {
